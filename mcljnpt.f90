MODULE LJNPTMC
  IMPLICIT NONE
  INTEGER*8, SAVE :: NUPDATES,NSTEP,NTOTAL,NACCPT,NTRANS
  INTEGER*8, SAVE :: NTACCPT,NACC,NVSTEP,NVACC,NVACCT,NSWPATT(2),NSWAPS(2)
  INTEGER, SAVE :: UFREQ,BLCK,VSFREQ,REFRESH,MCUF,WFREQ,NVOUT,NEQUIL,FFREQ,PWFREQ,SWPINT(2),CSTEP(2)
  DOUBLE PRECISION, SAVE :: STPLEN,VSLEN,RCON,MAXBL,PWCUT
  LOGICAL, SAVE :: CHNGV
...
SUBROUTINE INITIALIZE_LJNPTMC(NSTP,UFR,WRF,MCF,SI,SLEN,VLEN,RCN,Q,CONT,N,VSF,RFRSH,MBL,VOF,NEQL,FRCF,PWFRF,PWC)
  USE LJNPTMC
  IMPLICIT NONE
  INTEGER*8 :: NSTP
  INTEGER :: UFR,WRF,MCF,SI,CONT,N,VSF,VOF,NEQL,FRCF,PWFRF
  DOUBLE PRECISION :: SLEN,SFAC,RCN,VLEN,RFRSH,Q(3,N),MBL,PWC
  ...
  NEQUIL=NEQL                     ! Number of equilibration steps
  ...
  FFREQ=FRCF                    ! Frequency for writing net forces
  PWFREQ=PWFRF                  ! Frequency for writing pair-wise forces
  PWCUT=PWC                     ! Pair-wise cutoff for force calculation
