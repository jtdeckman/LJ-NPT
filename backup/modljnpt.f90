MODULE LJNPTMOD
     ...
     INTEGER, SAVE :: GRIDSIZE,FILEIND,VFILEIND,QFILEIND,VOLFIND,FRCFIND,ARRYSIZE,mynode
     ...
     DOUBLE PRECISION, SAVE :: VNEW,VCURR,VMCONV,LJ12,LJ6,LJNEW12,LJNEW6,PVCURR,VDIFF,EAVEFD
     ...
     CHARACTER*100 :: CNST,FNAME,VFNAME,QFNAME,VOLFNAME,FRCFNAME
